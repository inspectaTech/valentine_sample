...
<div id="arc_stage" class="test_grey arc_stage ui-grid-b">
	...
	<button class="arc_cnxs arc_intro_btn ui-btn "  data-rel="popup" data-position-to="window" data-transition="pop" ></button>
	<button class="arc_communities arc_intro_btn arc_intro_btn ui-btn"  ></button>
</div>
<script>
