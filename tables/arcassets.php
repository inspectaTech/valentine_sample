...
class TableArcAssets extends JTableNested
{
    ...
    if($display_data == "group"){
    $values[] =  $db->quote(htmlentities($arc_input->info_ids));
    }
    ...
    //TODO:160 i need to check if the id belongs to the user
    ...
    $display_data = $dsp_Dta;
      ...
      if($display_data == "group"){
      $fields[] =  $db->quoteName('info_ids') . ' = ' . $db->quote(htmlentities($arc_input->info_ids));
      }
